...
Last updated 2026-06-08. **Phase 1–3 complete** (see earlier notes). **Visualization booklets complete + extended** (2026-06-08): two thesis-grade booklets assembled and visually QC'd — `outputs/booklets/models_booklet.pdf` (10 pages, BH + SIR) and `outputs/booklets/methodology_booklet.pdf` (14 pages, full OPG pipeline + 2 new creative figures). **106 tests pass** on branch `feat/visualization-booklets`. Three cosmetic fixes applied after visual review. Two new methodology figures added (commit cd68330):
